...
# -------Создаем игровую клавиатуру без ипользования билдера---------
...
button_3 = KeyboardButton(text=LEXICON_RU['scissor'])

# Создаем игровую клавиатуру "Камень 🪨", "Ножницы ✂",
# "Бумага 🧻" как список списков
